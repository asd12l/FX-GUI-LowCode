 ...
 * @LastEditors: 卜倩倩
 * @LastEditTime: 2023-11-22 17:00:45
-->
<template>
  <div
  ...
  >
    <div class="videoContent">
      <div
        ...
        :style="{
          'line-height': (config.width - 40) * 0.45 / 1.8 + 'px'
        }"
      ></div>
      <div v-else>
    ...
    getStreamStart() {
      stream_start({
        ...
        .then((res) => {
          ...
          console.log(this.videoUrl, this.isShowNoVideo, '==============111');
        })
        .catch(() => {
          this.videoUrl = '';
...
.playback-wrapper1 {
  ...
  .videoContent {
    ...
    &__empty__box {
      ...
      text-align: center;
      color: #fff;
      background-image: url('../../assets/image/common/whmtp.png');
