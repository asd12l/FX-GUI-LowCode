    ...
    <div class="table-body">
      ...
      >
        ...
        >
          <div class="img-box">
            <el-image
              v-if="item.alarm_img && JSON.parse(item.alarm_img)[0] && JSON.parse(item.alarm_img)[0].thumbnail_full_path"
              :src="JSON.parse(item.alarm_img)[0].thumbnail_full_path"
              :preview-src-list="[item.alarm_img && JSON.parse(item.alarm_img)[0] && JSON.parse(item.alarm_img)[0].length ? JSON.parse(item.alarm_img)[0].thumbnail_full_path : '']"
              @click.native.stop
            >
              <div
                slot="error"
          ...
          <div class="table-body-cell">
            <div class="cell_event_name">
              ...
              <span
                class="event_status"
                :style="{
                  color: getColor('alarm_grade_a', item.alarm_grade_a)
                }"
              >{{ item.alarm_grade_a }}</span>
            </div>
            ...
            <div class="cell_event_device">
              <span
                ...
                background: getColor('alarm_type', item.alarm_type) ? (getColor('alarm_type', item.alarm_type)).slice(
                              0,
                              (getColor('alarm_type', item.alarm_type)).lastIndexOf(',')
                            ) + ',.2)': ''
              }"
