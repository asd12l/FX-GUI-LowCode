              ...
              >
                <div class="nodeinfo">
                  ...
                  <div class="stepinfo-single-right">
                    ...
                    ></span>
                    <span :style="{
                      color: getColor(getOperation(item.workItems[0]))
                    }">{{ getOperation(item.workItems[0]) }}</span>
                  </div>
                </div>
                <div
                  class="remarks"
                ...
                >
                  <div class="nodeinfo">
                    ...
                    <div class="right">
                      ...
                      ></span>
                      <span :style="{
                        color: getColor(getOperation(el))
                      }">{{getOperation(el)}}</span>
                    </div>
                  </div>
                  <div
                    class="remarks"
...
export default {
  ...
  methods: {
    ...
    getColor(param) {
      if (
        this.config.stepFieldConfig.filter((item) => item.value === param)
          .length
      ) {
        return this.config.stepFieldConfig.filter(
