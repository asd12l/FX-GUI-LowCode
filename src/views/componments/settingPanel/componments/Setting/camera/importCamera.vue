 ...
 * @version: 
 * @Author: ydl
 * @Date: 2023-10-10 14:31:53
 * @LastEditors: ydl
 * @LastEditTime: 2023-10-30 15:22:42
-->
<template>
          ...
          <div>
            ...
            <el-form-item label="控制台：">
              <div class="flex align-center" style="margin-left:10px;width:95%">
                <el-slider v-model="config.controlSize"
                @change="(val) => $emit('changeSize', 'controlSize', val)"></el-slider>
              </div>
            </el-form-item>
          </div>
        </el-collapse-item>
...
export default {
  ...
  data() {
    return {
      ...
      imgList: [
        require("@/assets/component/img/titlebg1.png"),
  ...
  mounted() {
    console.log(this.config, "===config====importCamera");
  },
  methods: {
    changeBar(data) {
