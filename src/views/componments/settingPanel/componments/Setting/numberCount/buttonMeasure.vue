    ...
    >
      ...
      <el-collapse>
        <el-collapse-item title="按钮图片" name="titleNumber">
          ...
          >
            ...
            <div v-if="config.buttonStyle.hoverShow">
              <ImageSelector
                label="边框图片："
                @changeSrc="
                  (val) => $emit('changeValue', 'hoverStyle', 'background', val)
                "
                worksheetId="buttonView"
          ...
          <el-collapse-item title="工具列表框" name="droupOption">
            ...
            <div v-if="config.optionStyle.optionShow">
              ...
              <el-collapse-item title="选项" name="droupOption2" 
                style="margin-bottom:5px">
                <el-form-item label="高度：">
                  <el-input
                ...
                >
                  ...
                  <ImageSelector
                    label="文本前图片："
                    @changeSrc="
                  (val) => $emit('changeValue', 'img', i, val)
                "
                    worksheetId="buttonView"
                    imageField="wbqtp"
                    :src="config.img[i]"
                  ...
                  <el-form-item label="图片右边距：" label-width="120px">
                    <div class="flex align-center">
                      <!-- <el-input
              ...
              >
                <div>
                  <el-form-item label="按钮宽高：" label-width="120px">
                    <div class="flex align-center">
                      <el-input
                        v-model="config.cleanBtn.width"
                        size="mini"
                        placeholder="宽"
                      ></el-input
                      >x<el-input
                        v-model="config.cleanBtn.height"
                        size="mini"
                        placeholder="高"
                      ></el-input>
                    </div>
                  ...
                  <el-form-item label="字体大小：">
                    <div class="flex align-center">
                      <el-input
                        v-model="config.cleanBtn.fontSize"
                        size="mini"
                        style="margin: 0 8px 0 0px"
                      ></el-input
                      >px
                  ...
                  <el-form-item label="文字背景颜色：">
                    <div class="flex align-center" style="color: aliceblue;">
                      <el-color-picker
                        v-model="config.cleanBtn.color"
                        show-alpha
                        size="mini"
                        style="margin-right: 5px;"
                      ></el-color-picker>
                      <el-color-picker
                        v-model="config.cleanBtn.background"
                        show-alpha
                        size="mini"
                        style="margin-right: 5px;"
                      ></el-color-picker>
